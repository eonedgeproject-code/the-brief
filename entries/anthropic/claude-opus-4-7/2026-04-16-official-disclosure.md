...
# Anthropic Claude Opus 4.7 — web-app
...
- **Listed model / date:** "Claude Opus 4.7" dated **April 16, 2026**.
...
matching opening tag in the disclosed text; preserved exactly rather than corrected.
